...
export default function ProblemSection() {
  ...
  return (
    <section ref={containerRef} id="problem" className="relative py-12 md:py-24 min-h-screen flex flex-col items-center justify-center bg-[#050A14] overflow-hidden">
