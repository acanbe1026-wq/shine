...
<script>
  Kakao.init('81ea07c45d8be29097260a07d240eaeb'); // 사용하려는 앱의 JavaScript 키 입력
</script>
<script>
/* function addChannel() {
	Kakao.Channel.addChannel({
		channelPublicId: '_TcgQxj',
	});
} */
function chat() {
	Kakao.Channel.chat({
		channelPublicId: '_TcgQxj' // 카카오톡 채널 홈 URL에 명시된 id로 설정합니다.
	});
}
</script>
...
ChannelIO('boot', {
 	"pluginKey": "7cbb2b03-5385-4133-aefb-60a264cb60bc" // fill your plugin key
});
</script>
    ...
    <div class="body_wrap">
        ...
        <div class="container">
            ...
            <div class="main_section_04">
                ...
                <ul class="appl">
                    <li class="aniToTop1">
                        <a href="javascript:void();" onclick="chat()">
                            <h4>
                                “계약의 신”<br>
                                <b>ERP 중개업소 회원신청</b>
                            </h4>
            ...
            <div class="main_section_05">
                <div class="notice">
                    <h3>고객센터</h3>
                    <div id="add-channel-button" class="one channel"></div>
                    <a href="javascript:void();" onclick="chat()" class="one chat"><span>1대1 문의하기</span></a>
...
?>
                            <li class="swiper-slide">
                                <a href="/notice.php?mode=read&seq=<?=$PageLs1->mData[$i]["seq"]?>" class="more"><img src="/images/plus.png"></a>
                                <a href="/notice.php?mode=read&seq=<?=$PageLs1->mData[$i]["seq"]?>">
...
?>
                            <li class="swiper-slide">
                                <a href="/faq.php?mode=&seq=<?=$PageLs2->mData[$i]["seq"]?>" class="more"><img src="/images/plus.png"></a>
                                <a href="/faq.php?mode=&seq=<?=$PageLs2->mData[$i]["seq"]?>">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . "/admaster/popup_div.php"?>
    <script>
